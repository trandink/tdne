...
$sql1 = "SELECT chitietdiem.id_hocsinh, hocsinh.hoten, chitietdiem.diem15phut, chitietdiem.diem1tiet, chitietdiem.diemcuoiky FROM chitietdiem INNER JOIN hocsinh ON chitietdiem.id_hocsinh = hocsinh.id_hocsinh WHERE chitietdiem.id_bangdiem = '$id_bangdiem' ";
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["diem15phut"]?></td>
                                    <td><?php echo $row["diem1tiet"]?></td>
