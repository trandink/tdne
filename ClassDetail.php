...
session_start();
$id_lop = $_GET["id_lop"];
$sql = "SELECT hocsinh.id_hocsinh, hocsinh.hoten, hocsinh.gioitinh, hocsinh.ngaysinh, hocsinh.diachi FROM hocsinh INNER JOIN lop ON lop.id_lop = hocsinh.id_lop WHERE hocsinh.id_lop = '$id_lop'";
$stmt = $conn->prepare($sql);
$query = $stmt->execute();

$sql1 = "SELECT tenlop FROM lop WHERE id_lop = '$id_lop'";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-10 content">
                <p class="page_title"><?php echo "Danh sách lớp '$tenlop'"?></p>
                ...
                <div class="table-responsive">
                    <table class="data_table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <span>
                                <td>
                                    <a href="editStudent.php?id_hocsinh=<?php echo $row["id_hocsinh"]?>">Sửa</a>
                                    <a href="deleteStudent.php?id_hocsinh=<?php echo $row["id_hocsinh"]?>">Xóa</a>
                                </td>
                                </span>          
                            </tr>
                            <?php
                    ...
                    <a class="btn btn-primary" href="listClasses.php">Quay lại</a>
                </div>                
            </div>
        </div>
    </div>
