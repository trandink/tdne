...
include"connect.php";
session_start();
$sql = "SELECT hocsinh.id_hocsinh, hocsinh.hoten, lop.tenlop, hocsinh.gioitinh, hocsinh.ngaysinh, hocsinh.diachi FROM hocsinh INNER JOIN lop ON lop.id_lop = hocsinh.id_lop WHERE lop.tenlop ='Không'";
                    ...
                    <table class="data_table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <span>
                                <td>
                                    <a href="addStudenttoClass.php?id_hocsinh=<?php echo $row["id_hocsinh"]?>">Thêm</a>
                                </td>
                                </span>          
                            </tr>
                            <?php
