...
include"connect.php";
session_start();
$sql = "SELECT id_lop, tenlop, khoi, (SELECT COUNT(*) FROM hocsinh WHERE hocsinh.id_lop = lop.id_lop) AS siso FROM lop WHERE tenlop != 'Không'";
        ...
        <div class="row">
            ...
            <nav class="col-lg-2 navbar-collapse collapse expand-lg" id="nav_bar">
                ...
                <div class="nav_group">
                    ...
                    <a href="./listClasses.php" class="nav_option current_item">Lớp học</a>
            ...
            <div class="col-lg-10 content">
                <!--    Content here -->
                <p class="page_title" >Danh sách lớp học</p>
                <div class="table-responsive">
                    <table class="data_table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <span>
                                <td>
                                    <a class="btn btn-info" style="width: 75px;" href="ClassDetail.php?id_lop=<?php echo $row["id_lop"]?>">Chi tiết</a>
                                    <a class="btn btn-danger" style="width: 50px;" href="deleteClass.php?id_lop=<?php echo $row["id_lop"]?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                        }
                ...
                <a class="btn btn-primary" href="listStudentsnotAdded.php">Thêm vào lớp</a>
                </div>
            </div>
        </div>
    </div>
