        ...
        <div class="row">
            ...
            <nav class="col-lg-2 navbar-collapse collapse expand-lg" id="nav_bar">
                ...
                <div class="nav_group">
                    ...
                    <a href="./listSubjects.php" class="nav_option current_item">Môn học</a>
            ...
            <div class="col-lg-10 content">
                <!--    Content here -->
                <p class="page_title">Danh sách môn học</p>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <span>
                                        <td>
                                            <a class="btn btn-primary" style="width:50px" href="editSubject.php?id_monhoc=<?php echo $row["id_monhoc"]?>">Sửa</a>
                                            <a class="btn btn-danger" style="width:50px" href="deleteSubject.php?id_monhoc=<?php echo $row["id_monhoc"]?>">Xóa</a>
                                        </td>
                                    </span>
                                </tr>
                                <?php
