<?php
    ...
    if(!empty($_POST["submit"])){
        if (isset($_POST["tenlop"]) && isset($_POST["khoi"])) {
            $tenlop = $_POST["tenlop"];
            $khoi = $_POST["khoi"];

            $sql = "INSERT INTO lop(tenlop, khoi) VALUES ('$tenlop', '$khoi')";
        ...
        <div class="row">
            ...
            <nav class="col-lg-2 navbar-collapse collapse expand-lg" id="nav_bar">
                ...
                <div class="nav_group">
                    ...
                    <a href="./createClass.php" class="nav_option current_item">Lớp học</a>
            ...
            <div class="col-lg-8 content">
                <p class="page_title">Thêm lớp học</p>
                <form action="" method="post">
                    <label for="tenlop" class="required">Tên lớp</label>
                    <input name="tenlop" type="text" class="form-control">
                    <label for="khoi" class="required">Khối</label>
                    ...
                    <br>
                    <a class="btn btn-secondary" href="listClasses.php">Hủy</a>
