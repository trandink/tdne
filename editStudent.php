        ...
        <div class="row">
            ...
            <div class="col-lg-8 content">
                ...
                <form action="" method="post">
                    ...
                    <input name="hoten" type="text" class="form-control" value="<?php echo $result['hoten']?>">
                    <label for="ngaysinh" class="required">Ngày sinh</label>
                    <input name="ngaysinh" type="date" class="form-control" value="<?php echo $result['ngaysinh']?>">
                    <label for="diachi" class="required" >Địa chỉ</label>
                    <input name="diachi" type="text" class="form-control" value="<?php echo $result['diachi']?>">
