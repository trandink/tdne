...
$sql1 = "SELECT * FROM monhoc WHERE id_monhoc = '$id_monhoc'";
...
if(!empty($_POST["submit"])){
    if (isset($_POST["mamonhoc"]) && isset($_POST["tenmonhoc"])) {
        ...
        $sql = "UPDATE monhoc SET mamonhoc = '$mamonhoc', tenmonhoc = '$tenmonhoc' WHERE id_monhoc = '$id_monhoc' ";
        ...
        <div class="row">
            ...
            <div class="col-lg-8 content">
                ...
                <form action="" method="post">
                    <label for="mamonhoc" class="required">ID Môn học</label>
                    <input name="mamonhoc" type="text" class="form-control" value="<?php echo $result['mamonhoc']?>">
                    <label for="tenmonhoc" class="required">Tên môn học</label>
                    <input name="tenmonhoc" type="text" class="form-control" value="<?php echo $result['tenmonhoc']?>">
                    <br>
