<?php
    include"connect.php";
    $sql1 = "SELECT id_hocsinh, hoten FROM hocsinh";
        ...
        <div class="row">
            ...
            <nav class="col-lg-2 navbar-collapse collapse expand-lg" id="nav_bar">
                ...
                <div class="nav_group">
                    ...
                    <a href="./searchTranscript.php" class="nav_option current_item">Tra cứu điểm</a>
                </div>
            </nav>
            <div class="col-lg-10 content">
                <!--    Content here -->
                <p class="page_title">Tra cứu điểm</p>
                <div class="table-responsive">
                    <form action="">
                        ...
                        <select name="students" id="students" class="form-control">
                            ...
                            ?>
                            <option value="<?php echo $student['id_hocsinh']; ?>"><?php echo $student['hoten']; ?></option>
                        <?php } ?>
                        </select>
                        <br>
