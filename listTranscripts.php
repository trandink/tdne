...
include "connect.php";
session_start();
$sql = "SELECT bangdiem.id_bangdiem, lop.tenlop, monhoc.tenmonhoc, bangdiem.hocky FROM bangdiem INNER JOIN lop ON bangdiem.id_lop = lop.id_lop INNER JOIN monhoc ON bangdiem.id_monhoc = monhoc.id_monhoc";
...
<head>
    <title>Danh sách bảng điểm | Quản lý học sinh</title>
        ...
        <div class="row">
            ...
            <nav class="col-lg-2 navbar-collapse collapse expand-lg" id="nav_bar">
                ...
                <div class="nav_group">
                    ...
                    <a href="./listTranscripts.php" class="nav_option current_item">Bảng điểm</a>
                </div>
                <div class="nav_group">
            ...
            <div class="col-lg-10 content">
                <!--    Content here -->
                <p class="page_title">Danh sách bảng điểm</p>
                <div class="table-responsive">
                    <table class="data_table table-striped table-bordered">
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $row["id_bangdiem"]?></td>
                                    <td><?php echo $row["tenlop"]?></td>
                                    <td><?php echo $row["tenmonhoc"]?></td>
                                    <td><?php echo $row["hocky"]?></td> 
                                    <span>
                                <td>
                                    <a class="btn btn-info" style="width:75px" href="OneTranscriptDetail.php?id_bangdiem=<?php echo $row["id_bangdiem"]?>">Chi tiết</a>
                                    <a class="btn btn-primary" style="width: 50px" href="createTranscriptDetail.php?id_bangdiem=<?php echo $row["id_bangdiem"]?>">Sửa</a>
                                    <a class="btn btn-danger" style="width:50px" href="?id_bangdiem=<?php echo $row["id_bangdiem"]?>">Xóa</a>
                                </td>
                                </span>          
                            </tr>
                            <?php
